...
public class DefaultVelocityLiteral<S extends VelocitySource<P>, P> extends DefaultVelocityNode<S, P> implements VelocityLiteral<S, P> {
    ...
    public DefaultVelocityLiteral(List<String> names, String displayName, String description, List<Node<S>> children, String permission, boolean unsafePermission, boolean optional, Collection<RunConsumer<S>> runConsumers) {
