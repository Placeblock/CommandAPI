...
public abstract class AbstractPaperCommandAdapter<PL extends JavaPlugin, P> extends BukkitCommand implements MinecraftCommandBridge<Player, P, CommandSender, PaperCommandSource<P>> {
    @Getter
