...
public class EnumParameter<T extends Enum<T>, S extends Source<M>, M> implements Parameter<T, S, M> {
    private final Class<T> enumClass;
    private final T[] enumValues;

    @Override
    public T parse(ParseContext<S, M> ctx, ParsedCommand<S, M> cmd) throws ParseException {
