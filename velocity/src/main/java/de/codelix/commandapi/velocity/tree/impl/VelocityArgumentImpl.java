...
public class VelocityArgumentImpl<T, S extends VelocitySource<P>, P> extends VelocityNodeImpl<S, P> implements VelocityArgument<T, S, P> {
    ...
    public VelocityArgumentImpl(String name, Parameter<T, S, Component> parameter, T defaultValue, String displayName, String description, List<Node<S, Component>> children, String permission, boolean unsafePermission, boolean optional, Collection<RunConsumer> runConsumers) {
