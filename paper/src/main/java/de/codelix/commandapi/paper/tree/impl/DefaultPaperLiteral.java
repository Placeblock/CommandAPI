...
public class DefaultPaperLiteral<S extends PaperSource<P>, P> extends DefaultPaperNode<S, P> implements PaperLiteral<S, P> {
    ...
    public DefaultPaperLiteral(List<String> names, String displayName, String description, List<Node<S, TextComponent>> children, String permission, boolean unsafePermission, boolean optional, Collection<RunConsumer> runConsumers) {
