...
public class PaperLiteralImpl<S extends PaperSource<P>, P> extends PaperNodeImpl<S, P> implements PaperLiteral<S, P> {
    ...
    public PaperLiteralImpl(List<String> names, String displayName, String description, List<Node<S>> children, String permission, boolean unsafePermission, boolean optional, Collection<RunConsumer<S>> runConsumers) {
