...
public interface AdventureNodeBuilder<B extends AdventureNodeBuilder<B, R, S, P, C>, R extends AdventureNode<S, P, C>, S extends AdventureSource<P, C>, P, C> extends MinecraftNodeBuilder<B, R, S, P, C, Component> {
}
