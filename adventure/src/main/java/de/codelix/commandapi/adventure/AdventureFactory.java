...
public interface AdventureFactory<S extends AdventureSource<P, C>, P, C> extends MinecraftFactory<S, P, C, TextComponent> {
    AdventureLiteralBuilder<?, ?, S, P, C> literal(String name, String... aliases);

    <T> AdventureArgumentBuilder<T, ?, ?, S, P, C> argument(String name, Parameter<T, S, TextComponent> parameter);
}
