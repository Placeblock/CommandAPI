...
public interface AdventureCommand<S extends AdventureSource<P, C>, P, C, D extends AdventureDesign, L extends AdventureLiteralBuilder<?, ?, S, P, C>, A extends AdventureArgumentBuilder<?, ?, ?, S, P, C>> extends MinecraftCommand<S, P, C, TextComponent, D, L, A> {
}
