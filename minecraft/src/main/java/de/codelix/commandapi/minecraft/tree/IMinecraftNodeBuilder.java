...
public interface IMinecraftNodeBuilder<B extends IMinecraftNodeBuilder<B, R, S, P, C>, R extends CoreNode<S>, S extends MinecraftSource<P, C>, P, C> extends NodeBuilder<B, R, S> {
